...
You can follow the instructions below to transfer your domain from 1&1 to FreeDomain.pl.
...
Select the **Registration & Transfer** tab. In the section “Domain transfer lock” toggle the button to remove the dns.info.pl lock.
